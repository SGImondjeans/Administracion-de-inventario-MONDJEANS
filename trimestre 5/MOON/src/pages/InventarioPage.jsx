...
import { AlertCircle, Edit2, Trash2, Plus, Save, X, Package, DollarSign, Calendar, Layers, CheckCircle, XCircle } from 'lucide-react';
import axios from "axios"; // Corregido: era "axio"

// Configuración de la API real (igual que en proveedores)
const API_BASE_URL = 'http://localhost:8000/api';

// Componente de Navbar con Bootstrap
      ...
      <div className="container-fluid">
        ...
        <div className="collapse navbar-collapse" id="navAdmin">
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li className="nav-item">
              <a className="nav-link active text-primary fw-bold" href="/productos">
                <i className="bi bi-boxes me-1"></i>
                Productos
              </a>
            </li>
            <li className="nav-item">
              <a className="nav-link text-dark" href="/reportes">
            ...
            <li className="nav-item">
              <a className="nav-link text-dark" href="/permisos">
