      ...
      <div className="container-fluid">
        ...
        <div className="collapse navbar-collapse" id="navAdmin">
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li className="nav-item">
              <a className="nav-link active text-primary fw-bold" href="/ventas">
...
const VentaForm = ({ ventaEditada, onGuardado, onCancelar, loading, crearVenta, actualizarVenta }) => {
  ...
  useEffect(() => {
    if (ventaEditada) {
      setFormData({
        DocumentoCliente: ventaEditada.DocumentoCliente || '',
        FechaVenta: ventaEditada.FechaVenta || '',
        Total: ventaEditada.Total || '',
        MetodoPago: ventaEditada.MetodoPago || 'Efectivo',
        Estado: ventaEditada.Estado || 'Pendiente',
        Notas: ventaEditada.Notas || '',
        Usuario: ventaEditada.Usuario || ''
      });
    } else {
                  ...
                  <tr key={venta.IdVenta}>
                    ...
                    <td className="px-4 py-3">
                      <div>
                        ...
                        {venta.Notas && (
                          <small className="text-muted">
                            {venta.Notas.substring(0, 50)}{venta.Notas.length > 50 ? '...' : ''}
                          </small>
                        )}
                      </div>
                    </td>
