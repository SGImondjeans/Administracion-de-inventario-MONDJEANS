...
class VentaController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            // Si no es admin/empleado, solo mostrar sus propias ventas como cliente
            ...
            $ventasTransformadas = $ventas->map(function($venta) {
                return [
                    ...
                    'Estado' => $venta->Estado,
                    'Notas' => $venta->Notas,
                    'Usuario' => $venta->DocumentoUsuario
                ];
            });
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'Usuario' => 'required|string|max:20|exists:usuarios,NumeroDocumento'
        ]);
        ...
        try {
            $venta = Venta::create([
                ...
                'DocumentoUsuario' => $request->Usuario,
